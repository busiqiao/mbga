package cn.waitfor.mbga.integration.i18n;

import static org.junit.jupiter.api.Assertions.assertEquals;

import cn.waitfor.mbga.config.I18nConfig;
...
public class I18nTranslateTest {
  ...
  void getI18nMessage_givenLocaleToMessageSource_shouldReturnCorrespondingMessage() {
    String messageCn = messageSource.getMessage("mjga", new Object[] {"Java"}, Locale.CHINA);
    assertEquals("让 Java 再次伟大", messageCn);

    String messageEn = messageSource.getMessage("mjga", new Object[] {"Java"}, Locale.US);
